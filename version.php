<?php $title='Історія версій | tapinambur'; $style='system-style'; include_once($_SERVER['DOCUMENT_ROOT'].'/app/header.php'); ?>
<a class="fa fa-chevron-up" aria-hidden="true" id="up" title="Вгору"></a>
<div id="myContainer">
<h1>Історія версій</h1>
<h2>Версія 1.2 від 19 березня 2017</h2>
<p>Дякуємо, що читаєте наш сайт. Для кращого перегляду контенту ми виправили деякі помилки в роботі сайту та трохи змінили дизайн сайту</p>
...
<p>Виправлена помилка з нерівномірною висотою колонок. Також виправлені дрібні проблеми. Предрелізний версія</p>
