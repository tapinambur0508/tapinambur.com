...
<div id="myContainer"> 
  <div class="row">
    ...
    <?php foreach($news as $item): ?>
      <div class="cols col-4">
        ...
        <h2><?=$item['header'] ?></h2>
        <p><?=$item['content'] ?></p>
        <p align="center" id="view_detais"><a class="btn btn-default" href="/article.php?id=<?=$item['id'] ?>" 
          role="button">View details&nbsp;&raquo;</a></p>
      </div>
    <?php endforeach; ?>

    <div class="cols col-12">
       <p align="center" id="view_detais">
        <a href="/news.php" class="btn btn-danger btn-lg">Читати всі новини&nbsp;&raquo;</a>
      </p>
    </div>
  </div>
  ...
  <div class="row">
   ...
   <!-- Code -->
    ...
    <div class="cols col-12">
      <p align="center" id="view_detais">
        <a href="/news.php" class="btn btn-danger btn-lg">Перейти в магазин&nbsp;&raquo;</a>
      </p>
    </div>
  </div>
</div>
